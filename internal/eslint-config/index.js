...
export default defineConfig([
  ...
  },
  {
    ...
    rules: {
      ...
      'no-restricted-imports': [
        'error',
        {
          paths: [{ name: '@qi-ui', message: 'Use qi-ui instead.' }],
          patterns: [
            {
              group: [
                '@qi-ui/*',
  ...
  },
  {
    files: [
      ...
      'packages/qi-ui/**/*.{js,jsx,ts,tsx,vue}',
    ],
    rules: {
      'no-restricted-imports': [
        'error',
        {
          ...
          patterns: [
            ...
            {
              group: [
                '@qi-ui/theme-chalk/**/*.scss',
                '!@qi-ui/theme-chalk/src/*.scss',
                '@qi-ui/theme-chalk/src/el-*.scss',
              ],
              message: 'Use @qi-ui/theme-chalk/src/*.scss instead.',
            },
            {
              group: [
                '@qi-ui/theme-chalk/**/*.css',
                '!@qi-ui/theme-chalk/el-*.css',
                '!@qi-ui/theme-chalk/base.css',
              ],
              message: 'Use @qi-ui/theme-chalk/el-*.css instead.',
            },
            {
              group: [
                '@qi-ui/build',
